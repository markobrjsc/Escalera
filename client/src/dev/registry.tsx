...
export const previews: Preview[] = [
  ...
  { id: "MeldZone", title: "MeldZone", group: "Karten", render: () => <><State label="mit Melds"><Board><MeldZone melds={[demoMeld]} openMelds={[]} zoneClassName="" zoneRef={noop} onZoneClick={noop} meldRef={() => noop} onMeldActivate={noop} arrivals={{}} /></Board></State><State label="leer"><Board><MeldZone melds={[]} openMelds={[]} zoneClassName="" zoneRef={noop} onZoneClick={noop} meldRef={() => noop} onMeldActivate={noop} arrivals={{}} /></Board></State></> },
