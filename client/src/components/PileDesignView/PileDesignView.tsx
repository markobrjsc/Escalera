...
import { BOARD_TILT, DEAL_TIMING, usePrefersReducedMotion } from "../../lib/motion.js";
...
const DEMO_TOPS: Card[] = [
  { id: "demo-1", deck: 1, kind: "standard", rank: "7", suit: "hearts" },
  { id: "demo-2", deck: 1, kind: "standard", rank: "K", suit: "spades" },
  { id: "demo-3", deck: 1, kind: "standard", rank: "A", suit: "diamonds" },
  { id: "demo-4", deck: 1, kind: "standard", rank: "10", suit: "clubs" },
  { id: "demo-5", kind: "joker" },
  { id: "demo-6", deck: 2, kind: "standard", rank: "3", suit: "clubs" },
  { id: "demo-7", deck: 2, kind: "standard", rank: "Q", suit: "hearts" },
  { id: "demo-8", deck: 2, kind: "standard", rank: "9", suit: "diamonds" }
];
